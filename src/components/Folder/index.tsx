import { Container, ContentContainer, ExitContainer, FolderContainer, NameContainer, FolderName, Footer, Header, HeaderIcon, ItensQuantity, ItemsContainer } from "./styles";
